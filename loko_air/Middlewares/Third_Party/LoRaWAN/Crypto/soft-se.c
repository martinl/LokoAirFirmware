...
SecureElementStatus_t SecureElementInit( SecureElementNvmData_t *nvm, SecureElementGetUniqueId seGetUniqueId )
{
    ...
    // DKr, add ket from settings
    settings_get_lora_app_eui(SeNvm->JoinEui);
    settings_get_lora_dev_eui(SeNvm->DevEui);
    settings_get_lora_app_key(SeNvm->KeyList[APP_KEY].KeyValue);
    settings_get_lora_app_key(SeNvm->KeyList[NWK_KEY].KeyValue);
    settings_get_lora_app_key(SeNvm->KeyList[APP_S_KEY].KeyValue);
    settings_get_lora_app_key(SeNvm->KeyList[NWK_S_KEY].KeyValue);
#else /* LORAWAN_KMS == 1 */
    uint8_t itr = 0;
